...
from epinet_func.custom_checkpoint import CustomEvaluationCallback
from epinet_func.func_epinetmodel_dwsc import define_epinet
...
if __name__ == '__main__':
    ...
    ffname = 'epinet_sep_k' + str(kernel_size) + '_relu_rmsprop_100e'
    print('Name: ', ffname)
    networkname = ffname
    ...
    hist = model_25.fit(train_generator, steps_per_epoch=int(display_status_ratio),
                        ...
                        callbacks=[reduce_lr])  # , callbacks=[checkpoint, reduce_lr]
