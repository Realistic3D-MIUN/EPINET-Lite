...
@author: AliHassan
Author Implementation of REDARTS:
A. Hassan, M. Sjöström, T. Zhang and K. Egiazarian, "REDARTS: Regressive Differentiable Neural Architecture Search for Exploring Optimal Light Field Disparity Estimation Network," in IEEE Transactions on Emerging Topics in Computational Intelligence, doi: 10.1109/TETCI.2025.3592281. keywords: {Computer architecture;Search problems;Estimation;Neural architecture search;Feature extraction;Optimization;Light fields;Classification algorithms;Heuristic algorithms;Computational efficiency;DARTS;deep learning;disparity estimation;image classification;light field;neural architecture search},
"""
...
from epinet_func.func_epinasnet_b import define_epinet
...
if __name__ == '__main__':
    ...
    ffname = 'epinasnet_b_k' + str(kernel_size) + '_relu_rmsprop_100e'
    print('Name: ', ffname)
    networkname = ffname
