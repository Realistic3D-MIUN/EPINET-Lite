...
@author: AliHassan
Author Re-Implementation of Light-Weight EPINET - MMSP 2022
A. Hassan, M. Sjöström, T. Zhang and K. Egiazarian, "Light-Weight EPINET Architecture for Fast Light Field Disparity Estimation," 2022 IEEE 24th International Workshop on Multimedia Signal Processing (MMSP), Shanghai, China, 2022, pp. 1-5, doi: 10.1109/MMSP55362.2022.9949378. keywords: {Human computer interaction;Convolution;Conferences;Computational modeling;Estimation;Signal processing algorithms;Computer architecture;Light Field;Deep Learning;Disparity Estimation;Compression;Depthwise Separable Convolution},
"""
...
from epinet_func.func_epinetmodel_conv_dwsc import define_epinet
#from epinet_func.func_epinet_binarizednet import define_epinet
...
if __name__ == '__main__':
    kernel_size = 2#int(sys.argv[1])

    save_checkpoint = False

    ffname = 'epinet_conv_sep_k' + str(kernel_size) + '_relu_rmsprop_100e'
    print('Name: ', ffname)
    networkname = ffname
    ...
    hist = model_25.fit(train_generator, steps_per_epoch=int(display_status_ratio),
                        ...
                        callbacks=[reduce_lr])  # , callbacks=[checkpoint, reduce_lr, custom_eval_callback]
